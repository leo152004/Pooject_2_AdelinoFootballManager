...
public class Jogadores extends Pessoa {
    ...
    private  int statAt, statDef, angerLevel, titulos, nEquipa;
...
//    Random rand = new Random();
    ...
    private int getAngerLevel(){return angerLevel;}
    private void setAngerLevel(int angerLevel){this.angerLevel = angerLevel;}

    public int getStatAt() {
        return statAt;
    }
    ...
    public ArrayList<String> getLesoes() {
        return lesoes;
    }
    ...
    public int getnEquipa() {
        return nEquipa;
    }

    public void setLesoes(ArrayList<String> lesoes) {
        this.lesoes = lesoes;
    }

    public void setStatAt(int statAt) {
        this.statAt = statAt;
    }
    ...
    public void setnEquipa(int nEquipa) {
        this.nEquipa = nEquipa;
    }
